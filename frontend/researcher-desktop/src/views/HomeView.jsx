      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            ...
            <button
              onClick={() => {
                alert('Hospital Operators should register their clinical node with assigned hospital_id via the Registration Form or Hospital Workstation (Module 3).');
                setActiveScreen('request-access');
              }}
              style={{
                display: 'flex',
                alignItems: 'flex-start',
